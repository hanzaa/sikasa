...
const ChartSRKeluarTujuan = () => {
   ...
   const { data:dataSRKeluar, isError, isFetching, isLoading, refetch } = useQuery({
      queryKey: [
         "dataSRKeluar-data",
   ...
   const chartData = generateDataForChart(dataSRKeluar?.data ?? []);
...
export default ChartSRKeluarTujuan;
