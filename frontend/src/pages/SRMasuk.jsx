...
const SRMasuk = () => {
   ...
   const Dari = alamatSuratEksternalQuery.data;
   const Kepada = alamatSuratInternalQuery.data;
      ...
      queryFn: async () => {
         try {
            const response = await axios.get(
               `${import.meta.env.VITE_SERVER_LINK}/data/agendaSBMasuk`,
               {
                  params: {
   ...
   const updateRowMutation = useMutation(async (updatedRow) => {
      const apiUrl = `${import.meta.env.VITE_SERVER_LINK}/update/agendasrmasuk`; // Replace with the correct API endpoint for updating data
      try {
   ...
   const deleteRowMutation = useMutation(async (no_agenda) => {
      const apiUrl = `${import.meta.env.VITE_SERVER_LINK}/delete/agendasrmasuk`; // Replace with the correct API endpoint for deleting data
         ...
         <Stack>
            ...
            >
               ...
               >
                  <CSVLink
                     data={allData?.data ?? []}
                     filename="Agenda Surat Rahasia Masuk.csv"
                     headers={headers}
                  >
                     Unduh All File
                  </CSVLink>{" "}
               ...
               >
                  <CSVLink
                     data={exportData}
                     filename="Custom Agenda Surat Rahasia Masuk.csv"
                     headers={headers}
