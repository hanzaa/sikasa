...
const SRKeluar = () => {
   ...
   const deleteRowMutation = useMutation(async (no_agenda) => {
      const apiUrl = `${import.meta.env.VITE_SERVER_LINK}/delete/agendasrkeluar`; // Replace with the correct API endpoint for deleting data
         ...
         <Stack>
            ...
            >
               ...
               >
                  <CSVLink
                     data={allData?.data ?? []}
                     filename="Agenda Surat Rahasia Keluar.csv"
                     headers={headers}
                  >
                     Unduh All File
                  </CSVLink>{" "}
               ...
               >
                  <CSVLink
                     data={exportData}
                     filename="Custom Agenda Surat Rahasia Keluar.csv"
                     headers={headers}
